...
export default function Home() {
    return (
      <div className="container d-flex flex-column align-items-center">
        ...
        At this point I had worked several jobs whith computer based duties such as processing and filling shipping
        orders through the companies internal online sales app or ensuring that the stores physical inventory
        ...
        <p class="beau margin30 font70">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In the beginning my interest in a programming career was mainly financial as I had been in my previous line of work
        for awhile and I was time for a change. I had been using computers my entire life and even built my own PC, 
        so after researching several possible trades that would be lucrative but would take some time, even a few years,
        I believed web developing was the best choice.</p>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I appreciate you taking the time to read all this, I'll be updating it as I add new applications 
          and learn new techniques and technologies. Hope to hear from you soon!
